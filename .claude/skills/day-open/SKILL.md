...
**Проверка обновлений:** `cd /Users/avlakriv/IWE/DS-exocortex && bash update.sh --check 2>&1`. Если доступно обновление → добавить в «Требует внимания»: «Доступно обновление IWE → `/iwe-update`».
