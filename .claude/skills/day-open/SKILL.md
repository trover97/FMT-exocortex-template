...
```
Если есть новые коммиты → добавить в «Требует внимания»: «[repo] обновлён upstream → `cd /Users/avlakriv/IWE/[repo] && git pull --rebase`». После pull FPF/SPF → reindex: `bash /Users/avlakriv/IWE/DS-MCP/knowledge-mcp/scripts/selective-reindex.sh FPF` (или SPF).
