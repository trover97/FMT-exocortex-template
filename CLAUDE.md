...
> **Скилл ≠ Роль ≠ Протокол.** Скилл (`.claude/skills/`) = точечное действие с входом/выходом. Роль = контекст на всю сессию (CLAUDE.md репо). Протокол = ритуал стадии ОРЗ (protocol-*.md). Метод (Pack) → скилл (FMT) → рабочий экземпляр (/Users/avlakriv/IWE/.claude/skills/). Skill Discovery: `protocol-work.md §2b`.
...
- `/Users/avlakriv/IWE/` — рабочая директория (шаблон: `/Users/avlakriv/IWE`)
