...
#
# Использование:
#   bash .qwen/lib/capture_selftest.sh          — все уровни
#   bash .qwen/lib/capture_selftest.sh --l1     — только синтаксис
#   bash .qwen/lib/capture_selftest.sh --l2     — L1 + smoke
#   bash .qwen/lib/capture_selftest.sh --quiet  — только итог (CI-режим)
#
