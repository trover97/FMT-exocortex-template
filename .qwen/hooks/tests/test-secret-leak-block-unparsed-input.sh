...
#
# Запуск: bash .qwen/hooks/tests/test-secret-leak-block-unparsed-input.sh
...
git -C "$(dirname "$HOOK_DIR")/.." show 26199d0286^:.qwen/hooks/secret-bypass-lib.sh > "$OLD_LIB_DIR/secret-bypass-lib.sh" 2>/dev/null
