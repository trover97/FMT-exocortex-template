...
FUNCTION_ID="$1"
MANIFEST_FILE="$2"
# CLAUDE_ROOT = project root that CONTAINS .qwen/ (default: cwd). The old
# default ".qwen" produced ".qwen/.qwen/skills/..." — a path that never
# exists (issue #323).
RESIDENCY_GATE_PY="${CLAUDE_ROOT:-.}/.qwen/skills/residency-gate/residency-gate.py"
