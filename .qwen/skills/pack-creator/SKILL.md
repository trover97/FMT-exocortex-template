...
Передать имя домена (существительное, не тема и не инструмент — см. QWEN.md §1).
...
- НЕ пытаться обойти (это hook bypass, QWEN.md §2.6).
...
| `/ke`                     | Захват одного факта в Pack/QWEN.md/memory        | Точечно, не процесс           |
...
- ❌ Скилл правит SPF/FPF «потому что так логичнее» — hook должен сработать; если
  обходишь — нарушаешь QWEN.md §2.6.
...
- **QWEN.md §1** — Pack Creation Gate, fallback chain
