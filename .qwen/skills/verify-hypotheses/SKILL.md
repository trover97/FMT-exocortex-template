...
> **Not in scope:** не создаёт новые гипотезы (это Note-Review), не выполняет сверку на week-close автоматически (это шаг 6a `.qwen/skills/week-close/SKILL.md` — этот скилл дублирует тот же алгоритм для вызова вне недельного ритма), не редактирует исходные записи.
