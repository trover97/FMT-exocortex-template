...
- Мгновенная запись правил (1-3 строки) в QWEN.md.
...
|------------|------|-------|-------|
| `/ke` (этот скилл) | R14 Заказчик / R1 Стратег | Рубеж сессии, inline | Правило в QWEN.md / запись в `inbox/captures/<YYYY-MM>.md` |
...
|-----|------|-------|-----------|
| Правило для всех репо (1-3 строки) | `QWEN.md` (корень workspace) | Сразу | Нет |
| Правило для одного репо (1-3 строки) | `<repo>/QWEN.md` | Сразу | Нет |
