...
- [Anthropic Qwen Code skills](https://docs.anthropic.com/en/docs/claude-code/skills): skill discovery, supporting files, invocation behavior, and testing in Qwen Code.
