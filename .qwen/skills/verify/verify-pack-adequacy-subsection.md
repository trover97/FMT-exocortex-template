...
**Носитель свидетельства:** `README.md` пакета, `QWEN.md` пакета.
...
**Носитель свидетельства:** 8 корневых элементов структуры, создаваемой `pack-new` Шаг 4 (НЕ дерева `SPF/pack-template/`): `README.md`, `REPO-TYPE.md`, `QWEN.md`, `00-pack-manifest.md`, `ontology.md`, `01-domain-contract/`, `06-sota/` (или `sota_sources: none` в манифесте вместо директории), `07-map/`; плюс содержимое `07-map/`.
