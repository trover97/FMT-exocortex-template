...
**Evidence (детерминированное правило):** проверить наличие 8 корневых элементов структуры, создаваемой `pack-new` Шаг 4 (НЕ дерева `SPF/pack-template/` — там нет README/REPO-TYPE/QWEN.md): `README.md`, `REPO-TYPE.md`, `QWEN.md`, `00-pack-manifest.md`, `ontology.md`, `01-domain-contract/`, `06-sota/` (или `sota_sources: none` в манифесте вместо директории), `07-map/`.
