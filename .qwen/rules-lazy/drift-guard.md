...
> Hot-триггер: `${IWE_GOVERNANCE_REPO:-DS-strategy}/QWEN.md` § WP-REGISTRY drift guard. Этот файл — элаборация (WP-450 Ф1). Источник: peer-session 2026-06-01-21, `sessions/2026-06/2026-06-01-21-wp-registry-drift-guard/report.md`.
