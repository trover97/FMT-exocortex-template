...
> Hot-триггер: `${IWE_GOVERNANCE_REPO:-DS-strategy}/QWEN.md` § New-files guard. Этот файл — элаборация (WP-450 Ф1). Источник: peer-audit Claude + Kimi, `sessions/2026-06/2026-06-04-current-docs-audit/report.md`.
