...
1. Лимиты строк:
   ...
   - MEMORY.md ≤ 100
2. Устаревшие записи → обновить или удалить
3. Результат: отчёт «Memory audit: N файлов, M строк суммарно, K обновлено»
