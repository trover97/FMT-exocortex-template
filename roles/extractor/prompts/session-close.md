...
> Этот промпт выполняется Qwen Code при закрытии сессии (протокол Close).
...
Для **rule**: просто 1-3 строки текста для добавления в QWEN.md или memory/.
...
6. **Прочитай** QWEN.md целевого репо — нет ли противоречащих правил.
