...
**0.9.Inbox:** только материалы к обсуждению с командой (повестки, предложения, вопросы). НЕ хранить WP-context файлы — они в DS-my-strategy/inbox/. Подробно: DP.KR.001 §5.3.
