...
4. **Длинные документы - в спойлерах.** Если файл больше двух экранов - каждая логическая секция в `<details><summary><b>Название</b></summary>`. Без горизонтальных разделителей между спойлерами.
...
<details><summary><b>Особенности каналов</b></summary>
