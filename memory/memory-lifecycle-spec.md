...
> (17.09): "≤11 файлов" убрано из `CLAUDE.md §4` целиком, не заменено новым
...
|---|---|---|---|
| Число файлов памяти | — | — | **Снято** (issue #736, решение пилота 17.09) — текст "≤11 файлов" убран из `CLAUDE.md §4`: не имел кода-исполнителя, давно разошёлся с практикой, дублировал уже работающий бюджет по токенам ниже |
