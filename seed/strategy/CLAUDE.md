...
Каждый репозиторий в `/Users/avlakriv/IWE/` содержит `WORKPLAN.md` в корне с текущими РП.

**Агрегация:** При создании плана дня/недели Стратег:
1. Обходит все `/Users/avlakriv/IWE/*/WORKPLAN.md`
...
for repo in $(ls /Users/avlakriv/IWE/); do
  if [ -d /Users/avlakriv/IWE/$repo/.git ]; then
    echo "=== $repo ===" && cd /Users/avlakriv/IWE/$repo && git log --oneline --since="1 week ago" 2>/dev/null
  fi
done
```
...
> **Полное описание:** `/Users/avlakriv/IWE/CLAUDE.md` секция 2.
