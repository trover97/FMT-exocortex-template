...
| Что | Зачем | Аналогия |
|-----|-------|----------|
| **Qwen Code** | ИИ-ассистент, который читает твои файлы и помнит контекст | Напарник, а не поисковик |
...
| ИИ не помогает | **Ядро + культура** (Qwen Code + экзокортекс) | Читает ТВОИ файлы, знает ТВОИ цели, помнит ТВОЮ историю |
...
Три действия:
1. Установить VS Code и Qwen Code *(бесплатно)*
2. Создать аккаунт на GitHub *(бесплатно)*
3. Запустить одну команду

> **ИИ поможет.** Скажи Qwen Code: «Помоги мне установить IWE» — он проведёт через каждый шаг.
...
> После установки ты общаешься с Qwen Code **на русском языке**.
...
|------|----------------|---------------|
| **Этап 1** | Qwen Code + экзокортекс | ИИ-ассистент, который тебя помнит |
