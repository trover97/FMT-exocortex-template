...
graph TB
    ...
    subgraph pair["<b>ПАРА: ТЫ + ИИ</b>"]
        ...
        AI["<b>Qwen Code</b><br/>Усиливает, структурирует<br/>Берёт рутину"]
...
graph LR
    ...
    S2["<b>Шаг 2</b><br/>Установи<br/><i>~20 мин</i><br/>────────<br/>VS Code + Qwen Code<br/>+ GitHub аккаунт"]
...
```mermaid
graph BT
    E1["<b>Этап 1 — Старт</b><br/>Qwen Code + экзокортекс<br/>────────<br/>ИИ-ассистент, который<br/>тебя помнит"]
...
graph LR
    ...
    S2["<b>Культура работы</b><br/>Ритуалы ОРЗ<br/>+ Qwen Code"]
    S3["<b>Ядро + культура</b><br/>Qwen Code<br/>+ экзокортекс"]
